...
<div class="kt-section">
                    <span class="kt-section__info">
                       Permanent Applicant Registrations
                    </span>
    `
...
<script>
    oTable = $('#del-table').DataTable({
        ...
        'serverMethod': 'post',
        'ajax': {
            'url': 'ajax/paginations/permregdel.php'
        },
        'columns': [
            {data: 'fulldetails'},
            {data: 'email_address'},
    ...
    $(document).off('click', '.deleteperm_btn').on('click', '.deleteperm_btn', function () {
        var i_index = $(this).attr('i_index');
        //alert(i_index);

        $.confirm({
            title: 'Delete Permanent Registration Details!',
            ...
            buttons: {
                ...
                yes: {
                    ...
                    action: function () {
                        $.ajax({
                            type: "POST",
                            url: "ajax/queries/delete_permreg.php",
                            data: {
                                i_index: i_index
                            },
                            dataType: "html",
                            success: function (text) {
                                //alert(text);
                                $.ajax({
                                        url: "ajax/tables/delperm_table.php",
                                        beforeSend: function () {
                                            KTApp.blockPage({
                                                overlayColor: "#000000",
                                                type: "v2",
