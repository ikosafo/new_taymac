...
$query = $mysqli->query("Select * from provisional where provisional_pin is not null and temporal_registration = '1'
                          and temporal_date_approval BETWEEN '$start_date' AND '$newenddate' ORDER BY temporal_date_approval DESC");
            ...
            <table class="table" id="prov_table">
                ...
                <?php while ($result = $query->fetch_assoc()){
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo $result['temporal_date_approval'] ?>
                        </td>
                    </tr>
                <?php } ?>
                </tbody>
...
<script>
    ...
    var KTDatatablesExtensionButtons = {
        init: function () {
            ...
            $('#prov_table').append('<caption style="caption-side: top">Temporal Registration Pin Export between <?php echo $start_date;?> and <?php echo $end_date ?> </caption>');
