    ...
    <div class="kt-section__content responsive">
        ...
        <div class="kt-searchbar">
            <div class="input-group">
                ...
                <input type="text" id="renewal_search" class="form-control" placeholder="Search Full Name or email address" aria-describedby="basic-addon1">
            </div>
        </div>
...
<script>
    ...
    function doneTyping() {
        ...
        if (txtlen > 2) {
            ...
            $.ajax({
                type: "POST",
                url: "ajax/queries/renewal_search.php",
                beforeSend: function() {
                    KTApp.blockPage({
                        overlayColor: "#000000",
                        type: "v2",
