...
<script>
    ...
    var KTDatatablesExtensionButtons = {
        init: function() {
            ...
            if (year_search == 'All') {
                $('#prov_table').append('<caption style="caption-side: top">Permanent Registration Upgrade Export for all years</caption>');
            } else {
                $('#prov_table').append('<caption style="caption-side: top">Permanent Registration Upgrade Export for the year <?php echo $year_search ?></caption>');
            }
