...
$temporal_status = $_POST['temporal_status'];
...
<script>
    ...
    if (admintype == 'Super Admin') {
        oTable = $('#prov-table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': 'ajax/paginations/temporal_super.php?year=<?php echo $year_search ?>&status=<?php echo $temporal_status ?>'
            },
            'columns': [
                {data: 'provisionalid'},
                {data: 'email_address'},
                {data: 'provisional_pin'},
                {data: 'temporal_usercheck_status'},
                {data: 'temporal_admincheck_status'},
                {data: 'temporal_payment'},
        ...
        oTable = $('#prov-table').DataTable({
            ...
            'serverMethod': 'post',
            'ajax': {
                'url': 'ajax/paginations/temporal_mis.php?year=<?php echo $year_search ?>&status=<?php echo $temporal_status ?>'
            },
            'columns': [
                {data: 'provisionalid'},
                {data: 'email_address'},
