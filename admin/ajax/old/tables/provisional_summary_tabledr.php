...
<div id="print_this">
    ...
    <div class="row">
        <div class="col-md-6">
            PROVISIONAL REGISTRATIONS BETWEEN <b><?php echo $start_date ?></b> AND <b><?php echo $end_date ?></b>
        </div>
        <div class="col-md-3">
        ...
        <div class="kt-section__content responsive">
            ...
            if ($search_region == "Any" && $search_profession == "Any") {
                $query = $mysqli->query("SELECT * FROM provisional WHERE provisional_registration = '1'
                                        AND provisional_date_approval BETWEEN '$start_date' AND '$newenddate'
                    ORDER BY provisional_date_approval DESC,professionid,provisional_period DESC");
