...
$periodregistered = $result['temporal_period'];
...
$temporal_number = $result['provisional_pin'];

if ($temporal_number == ""){
    if ($index_number != '') {
        $mysqli->query("update provisional
    set
        temporal_admincheck_status = '$approve_state',
        temporal_admincheck_comment = '$remark',
        temporal_form_submitted = '$form_submitted',
        temporal_admincheck_user = '$user_id',
        temporal_date_approval = '$datetime',
        temporal_pin = '$index_number',
