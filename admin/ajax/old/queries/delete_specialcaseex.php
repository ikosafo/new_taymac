...
$getapp = $mysqli->query("select * from examination_special_cases where id = '$i_id'");
...
if (mysqli_num_rows($getcountappid) == "1") {
    ...
    $mysqli->query("delete from examination_special_cases where id='$i_id'") or die(mysqli_error($mysqli));
    echo 1;
}
