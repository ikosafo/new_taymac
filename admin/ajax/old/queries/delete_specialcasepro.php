...
$getapp = $mysqli->query("select * from provisional_special_cases where id = '$i_id'");
...
if (mysqli_num_rows($getcountappid) == "1") {
    ...
    $mysqli->query("delete from provisional_special_cases where id='$i_id'") or die(mysqli_error($mysqli));
    echo 1;
}
