...
if ($username == 'sey') {
            ...
            '$applicant_id',
            '$today',
            'Provisional')") or die(mysqli_error($mysqli));
            ...
            `ip_address`,
            `action`)
            VALUES ('Deleted Provisional registration for applicant with Applicant ID $applicant_id',
            '$today',
            '$username',
            '$mac_address',
            '$ip_add',
    ...
    `ip_address`,
    `action`)
    VALUES ('Attempted to delete Provisional registration for applicant with Applicant ID $applicant_id',
    '$today',
    '$username',
    '$mac_address',
    '$ip_add',
