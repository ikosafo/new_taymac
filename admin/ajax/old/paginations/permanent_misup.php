...
if ($status == "All") {
        ...
        where (registration_type = 'permanent_upgrade' OR registration_type = 'PERMANENT(UPGRADE)')");
                ...
                WHERE (registration_type = 'permanent_upgrade' OR registration_type = 'PERMANENT(UPGRADE)') AND 1 " . $searchQuery . " order by
                ...
                ## Total number of records without filtering
                $sel = mysqli_query($con, "select count(*) as allcount from registration_upgrades where (registration_type = 'permanent_upgrade' OR registration_type = 'PERMANENT(UPGRADE)')
        ...
        if ($year == "All") {
                ## Total number of records without filtering
                $sel = mysqli_query($con, "select count(*) as allcount from registration_upgrades where (registration_type = 'permanent_upgrade' OR registration_type = 'PERMANENT(UPGRADE)') AND usercheck_status = 'Approved'");
                $records = mysqli_fetch_assoc($sel);
                $totalRecords = $records['allcount'];
                ...
                ## Fetch records
                $empQuery = "select * from registration_upgrades WHERE (registration_type = 'permanent_upgrade' OR registration_type = 'PERMANENT(UPGRADE)') AND usercheck_status = 'Approved'  AND 1 " . $searchQuery . " order by
                               date_requested DESC limit " . $row . "," . $rowperpage;
                $empRecords = mysqli_query($con, $empQuery);
                $data = array();
        } else {
                ...
                ## Fetch records
                $empQuery = "select * from registration_upgrades WHERE (registration_type = 'permanent_upgrade' OR registration_type = 'PERMANENT(UPGRADE)') AND
        ...
        if ($year == "All") {
                ...
                $sel = mysqli_query($con, "select count(*) as allcount from registration_upgrades where
                           (registration_type = 'permanent_upgrade' OR registration_type = 'PERMANENT(UPGRADE)') AND usercheck_status = 'Rejected'");
                $records = mysqli_fetch_assoc($sel);
                $totalRecords = $records['allcount'];
        ...
        if ($year == "All") {
                ...
                ## Fetch records
                $empQuery = "select * from registration_upgrades WHERE (registration_type = 'permanent_upgrade' OR registration_type = 'PERMANENT(UPGRADE)') AND payment = '1'
...
while ($row = mysqli_fetch_assoc($empRecords)) {
        $data[] = array(
                ...
                "upgrade_id" => misupapproval($row['id'])
        );
}
