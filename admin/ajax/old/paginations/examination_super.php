...
## Total number of records without filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg 
            where period_registered BETWEEN '$startdate' AND '$enddate'
            AND exam_admincheck_status = 'Approved'");
            $records = mysqli_fetch_assoc($sel);
            $totalRecords = $records['allcount'];
...
## Total number of record with filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg 
            WHERE period_registered BETWEEN '$startdate' AND '$enddate'
            AND exam_admincheck_status = 'Approved' AND 1 ".$searchQuery);
            $records = mysqli_fetch_assoc($sel);
            $totalRecordwithFilter = $records['allcount'];
...
## Total number of records without filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg 
            where period_registered BETWEEN '$startdate' AND '$enddate'
            AND exam_admincheck_status = 'Rejected'");
            $records = mysqli_fetch_assoc($sel);
            $totalRecords = $records['allcount'];
...
## Total number of record with filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg 
            WHERE period_registered BETWEEN '$startdate' AND '$enddate'
            AND exam_admincheck_status = 'Rejected' AND 1 ".$searchQuery);
            $records = mysqli_fetch_assoc($sel);
            $totalRecordwithFilter = $records['allcount'];
...
## Total number of records without filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg 
            WHERE payment = '1'
            AND exam_usercheck_status = 'Approved' AND (exam_admincheck_status = '' OR exam_admincheck_status IS NULL)
...
## Total number of record with filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg 
            WHERE payment = '1'
            AND exam_usercheck_status = 'Approved' AND (exam_admincheck_status = '' OR exam_admincheck_status IS NULL) AND
            period_registered BETWEEN '$startdate' AND '$enddate' AND 1 ".$searchQuery);
            $records = mysqli_fetch_assoc($sel);
            $totalRecordwithFilter = $records['allcount'];
...
## Total number of records without filtering
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg 
                                        where exam_type = 'Supplementary' AND 
                                        period_registered BETWEEN '$startdate' 
                                        AND '$enddate'");
            $records = mysqli_fetch_assoc($sel);
            $totalRecords = $records['allcount'];
...
## Total number of record with filtering
           $sel = mysqli_query($con,"select count(*) as allcount from examination_reg
                                    WHERE  exam_type = 'Supplementary' AND period_registered 
...
## Fetch records
            ...
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg 
                                WHERE exam_type = 'Supplementary' AND payment = '1'
                                AND exam_usercheck_status = 'Approved' AND (exam_admincheck_status = '' 
                                OR exam_admincheck_status IS NULL)
                                AND period_registered BETWEEN '$startdate' AND '$enddate'");
            $records = mysqli_fetch_assoc($sel);
            $totalRecords = $records['allcount'];
            ...
            $sel = mysqli_query($con,"select count(*) as allcount from examination_reg 
                                    WHERE exam_type = 'Supplementary' AND payment = '1'
                                    AND exam_usercheck_status = 'Approved' AND 
                                    (exam_admincheck_status = '' OR exam_admincheck_status IS NULL) AND
                                    period_registered BETWEEN '$startdate' AND '$enddate' AND 1 ".$searchQuery);
            $records = mysqli_fetch_assoc($sel);
            $totalRecordwithFilter = $records['allcount'];
            ...
            $empQuery = "select * from examination_reg 
                        ...
                        AND exam_usercheck_status = 'Approved' AND 
                        (exam_admincheck_status = '' OR exam_admincheck_status IS NULL)
                        AND 1 ".$searchQuery." ORDER BY period_registered DESC,payment DESC limit ".$row.",".$rowperpage;
            $empRecords = mysqli_query($con, $empQuery);
            $data = array();
