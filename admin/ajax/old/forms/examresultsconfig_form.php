...
<form class="" autocomplete="off">
    <div class="kt-portlet__body">
        ...
        <div class="form-group">
            <label for="exampleInputEmail1">Results Date</label>
            <input type="text" id="date_started" class="form-control
                        date-picker-input" placeholder="Select Year" data-date-format="yyyy-mm-dd" autocomplete="off">
        </div>
        ...
        if (error == "") {
            $.ajax({
                ...
                success: function(text) {
                    //alert(text);
                    if (text == 2) {
                        $.notify("Registration already exists", {
                            position: "top center"
                        });
                    } else {
